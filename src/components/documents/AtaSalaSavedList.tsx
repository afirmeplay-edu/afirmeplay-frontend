...
import { deleteSavedAta, getAtaSalaApiError, listSavedAtas } from "@/services/documents/ataSalaApi";
import type { AtaModoLista, SavedAtaSummary } from "@/types/ata-sala";
          ...
          {items.map((item) => {
            ...
            return (
              ...
              >
                ...
                <CardFooter className="flex flex-wrap gap-2 border-t border-border/60 bg-muted/20 px-5 py-3 pl-5">
                  <Button
                    size="sm"

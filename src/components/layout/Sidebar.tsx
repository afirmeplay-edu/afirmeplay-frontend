      ...
      links: [
        ...
        },
        {
          ...
          children: [
            ...
            { icon: FileText, label: "Termo de compromisso", href: "/app/documentos/termo-compromisso", role: ["admin", "professor", "diretor", "coordenador", "tecadm"] },
        ...
        },
        {
          ...
          children: [
            ...
            { icon: ListChecks, label: "Mapa de questões", href: "/app/relatorios/mapa-questoes", role: ["admin", "professor", "diretor", "coordenador", "tecadm"] },
            { icon: ClipboardCheck, label: "Boletim do aluno", href: "/app/relatorios/boletim-aluno", role: ["admin", "professor", "diretor", "coordenador", "tecadm"] },
            { icon: Combine, label: "Relatório Unificado", href: "/app/relatorios/relatorio-unificado", role: ["admin", "professor", "diretor", "coordenador", "tecadm"], feature: "afirme_reading" },
            ...
            { icon: Trophy, label: "Ranking Geral", href: "/app/relatorios/ranking-geral", role: ["admin", "professor", "diretor", "coordenador", "tecadm"] },
